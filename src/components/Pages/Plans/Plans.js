  ...
  return (
    <div className="container">
      <div className="pricing_top">
        <h2 className='section_title'>Premiun Pricing Plan</h2>
        <p>Unlock elite tech services with our premium pricing plan and soar ahead of the compeition</p>
      ...
      <div className="pricing_wrapper">
        ...
        <div className="pricing_item" key={index}>
          <div className="pricing_card-top" style={{background: pricingItem.color}}>
            ...
            <h2 className='pricing_section_title'>{pricingItem.price} <span>{pricingItem.duration}</span>
            </h2>
