...
function Home() {
  const handleClick=()=>{
    ...
    window.open('https://www.youtube.com/watch?v=AcKEdVNGibA&t=4202s','_blank')
  }
  return (
    ...
    <div className="container">
      <div className="home-container">
        <div className="home-content">
          ...
          <p>Master Trending Technologies with My Website, Invest your Time and Return Skills.</p>
